 ...
 * interface.
 */
public class Fragment_LocationOpen extends ListFragment implements DialogFragment_FilterList.NoticeDialogListener{

	/**
	 * The serialization (saved instance state) Bundle key representing the
	 * activated item position. Only used on tablets.
	 */
    public static final String TAG = "Fragment_LocationOpen";
    ...
    public void onCreateOptionsMenu(Menu menu,MenuInflater inflater) {
        ...
        this.searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener()
        {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                ((Fragment_LocationOpen) getActivity().getSupportFragmentManager()
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.actionb_filter_list:
			...
			newFragment.setListener(Fragment_LocationOpen.this);
		    newFragment.show(Fragment_LocationOpen.this.getActivity().getSupportFragmentManager(), "filter");
			return true;
	...
	@Override
    public void onDialogPositiveClick(boolean[] filterlist, boolean filterOpen) {
